...
async def on_message(message):
    if message.author.id not in bot.config["banned"] and (message.channel.id not in bot.config["banned_channels"] or message.author.guild_permissions.manage_messages):
